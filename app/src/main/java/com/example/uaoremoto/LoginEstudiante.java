...
public class LoginEstudiante extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textCorreo = (EditText) findViewById(R.id.editTextLogE);
        textContra = (EditText) findViewById(R.id.editTextPassE);

        btnIngresar = (Button) findViewById(R.id.btnLogE);
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthUserCollisionException) {//si se presenta una colisión
                                Toast.makeText(LoginEstudiante.this, "El usuario o contraseña es erroneo", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(LoginEstudiante.this, "El usuario o contraseña es erroneo", Toast.LENGTH_LONG).show();
                            }
                        }
